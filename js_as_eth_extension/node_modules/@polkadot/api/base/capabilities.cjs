...
function detectedCapabilities(api, blockHash) {
  ...
  }, extractResults(cResults, consts), extractResults(qResults, queries), extractResults(rResults, raws))), (0, _operators.take)(1), (0, _operators.catchError)(() => (0, _xRxjs.of)({})));
}