      ...
      Object.defineProperty(this, _observeStatus, {
        ...
        value: (hash, status) => {
          ...
          return api.derive.tx.events(blockHash).pipe((0, _operators.map)(({
            ...
            status
          }))), (0, _operators.catchError)(internalError => (0, _xRxjs.of)((0, _classPrivateFieldLooseBase2.default)(this, _transformResult)[_transformResult](new _Result.SubmittableResult({
            internalError,
            status
          })))));
        }
