...
function encodeTypeDef(typeDef) {
  (0, _util.assert)(!(0, _util.isUndefined)(typeDef.info), () => `Invalid type definition with no instance info, ${(0, _util.stringify)(typeDef)}`); // In the case of contracts we do have the unfortunate situation where the displayName would
