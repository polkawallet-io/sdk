...
function prime(instanceId, api, _section) {
  ...
  return (0, _index.memo)(instanceId, () => {
    ...
    return (0, _util.isFunction)((_api$query = api.query[section]) === null || _api$query === void 0 ? void 0 : _api$query.prime) ? api.query[section].prime().pipe((0, _operators.map)(optPrime => optPrime.unwrapOr(null))) : (0, _xRxjs.of)(null);
  });
}